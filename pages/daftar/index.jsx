...
export default function SignUp() {
  ...
  const handleRegister = async (e) => {
    ...
    if (
      ...
      !(formUser.email === '' || formUser.email === null) &&
      !!/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(formUser.email) &&
      ...
      !(formUser.jenisKelamin === '' || formUser.jenisKelamin === null) &&
      !(formUser.alamat === '' || formUser.alamat === null) &&
      !(formUser.alamat.length < 3 || formUser.alamat.length > 100) &&
      !(formUser.kataSandi === '' || formUser.kataSandi === null) &&
      !(formUser.kataSandi.length < 8 || formUser.kataSandi.length > 20) &&
      !(formUser.CKataSandi === '' || formUser.CKataSandi === null) &&
      !(formUser.CKataSandi !== formUser.kataSandi) &&
